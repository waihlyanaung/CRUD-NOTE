    ...
    <div >
      <nav className="bg-gray-200 border-gray-200 dark:bg-gray-900">
        <div className=" flex flex-wrap items-center justify-between  p-4">
          ...
          {/* <h1>{user?.name}</h1>
          <h1>{user?.email}</h1> */}
          <p onClick={logoutHandler} className="flex items-center  gap-4  font-bold cursor-pointer"> <LuLogOut className=" text-black opacity-50 text-2xl" />LogOut</p>
            ...
            >
              ...
              >
                ...
                <li className="text-center px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">
                  {/* <p onClick={() => logoutHandler()} className="flex items-center  gap-4  font-bold"> <LuLogOut className=" text-black opacity-50 text-2xl" />Log Out</p> */}
                </li>
              </ul>
            </div>
          </div>
          ...
          >
            ...
            <ul className="visible lg:invisible flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
              <li>
                <a
                  href="#"
